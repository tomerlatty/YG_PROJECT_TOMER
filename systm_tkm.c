...
// this file contains all the definitions and the functions the relative to the token 
...
bool token_is_keyword(struct token* token, const char* value) // return if the token is keyword 
{
